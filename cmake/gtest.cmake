if (NOT TARGET gtest)
  set(GOOGLETEST_ROOT submodules/googletest/googletest CACHE STRING "Google Test source root")
...
if (NOT TARGET gmock)
  set(GOOGLEMOCK_ROOT submodules/googletest/googlemock CACHE STRING "Google Mock source root")
